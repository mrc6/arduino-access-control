...
////////////////////ASCIIToHex/////////////////////////////////////
  void asciiToHexValue(int toExtract[], byte resultArray[]){
    ...
    for(int i=0; i<8; i+=1){
      ...
      if(toExtract[i]=='a'||toExtract[i]=='A'){
        changedArray[i]=10;
      }
      if(toExtract[i]=='b'||toExtract[i]=='B'){
        changedArray[i]=11;
      }
      if(toExtract[i]=='c'||toExtract[i]=='C'){
        changedArray[i]=12;
      }
      if(toExtract[i]=='d'||toExtract[i]=='D'){
        changedArray[i]=13;
      }
      if(toExtract[i]=='e'||toExtract[i]=='E'){
        changedArray[i]=14;
      }
      if(toExtract[i]=='f'||toExtract[i]=='F'){
        changedArray[i]=15;
      }
    }
